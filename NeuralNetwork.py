...
from keras.callbacks import TensorBoard  # track accuracy, loss etc.
import numpy as np
import os
import random
...
model.compile(loss='catagorical_cossentropy',
              optimizer=opt,
              metrics=['accuracy'])

tenserboard = TensorBoard(log_dir='logs/stage1')

train_data_dir = "train_data"


# hackyway to lower 16gb of ram to a more managable amount of training data
